...
const StatsBox = ({ label, value }: any) => {
  return (
    <ImageBackground
      source={require('../../assets/draw_screen_solo_match/score_streak_box.png')}
...
const ResultButton = ({ onPress, title }: any) => {
  return (
    <Pressable onPress={onPress} style={({ pressed }) => [
      ...
      <ImageBackground
        source={require('../../assets/draw_screen_solo_match/rematch_home_button.png')}
...
export default function DrawScreen() {
  ...
  return (
    <ImageBackground 
      source={require('../../assets/draw_screen_solo_match/Sky.png')} 
    ...
    >
      <SafeAreaView style={styles.safeArea}>
        ...
        {/* Floating clouds */}
        <Image 
          source={require('../../assets/draw_screen_solo_match/cloud_1.png')} 
          style={[styles.cloud, { top: height * 0.1, left: -25, width: 140, height: 70 }]} 
          contentFit="contain" 
        />
        <Image 
          source={require('../../assets/draw_screen_solo_match/cloud_2.png')} 
        ...
        <View style={styles.container}>
          ...
          <View style={styles.titleContainer}>
            <Image
              source={require('../../assets/draw_screen_solo_match/draw.png')}
          ...
          <View style={styles.shareButtonContainer}>
            <Pressable onPress={handleShare} style={({ pressed }) => [styles.shareBtnContainer, pressed && { transform: [{ translateY: 2 }] }]}>
              <ImageBackground
                source={require('../../assets/draw_screen_solo_match/share_button.png')}
          ...
          {/* Character standing on cracked Defeated Stadium platform */}
          <View style={styles.sceneSection}>
            {/* Platform + Sad Guy avatar */}
            <View style={styles.characterGroup}>
              <Image 
                source={require('../../assets/draw_screen_solo_match/SAD GUY.png')} 
            ...
            <Image 
              source={require('../../assets/draw_screen_solo_match/Defeated Stadium.png')} 
              style={styles.pedestal} 
              contentFit="contain" 
            />
          </View>

          {/* Play Again/Go Home Action Buttons */}
